...
export default class LevelMaker {
	...
	static levelOne() {
		const blocks = [
			new GlassBlock(LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 0.25, CANVAS_HEIGHT - Ground.GRASS.height - Block.SPRITE_MEASUREMENTS[Size.Medium].height, Size.Medium),
			new GlassBlock(LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 4.75, CANVAS_HEIGHT - Ground.GRASS.height - Block.SPRITE_MEASUREMENTS[Size.Medium].height, Size.Medium),
			new GlassBlock(LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 2.5, CANVAS_HEIGHT - Ground.GRASS.height - Block.SPRITE_MEASUREMENTS[Size.Medium].height * 2, Size.Large, Block.ANGLE_HORIZONTAL),
		];
		...
		const birdQueue = new BirdQueue([BirdType.White, BirdType.Blue, BirdType.Red]);
	...
	static levelTwo() {
		const blocks = [
			...
			new GlassBlock(LevelMaker.START_X + Block.SPRITE_MEASUREMENTS[Size.Medium].width * 4.75, CANVAS_HEIGHT - Ground.GRASS.height - Block.SPRITE_MEASUREMENTS[Size.Medium].height * 2, Size.Medium),
		...
		const birdQueue = new BirdQueue([BirdType.White, BirdType.Red, BirdType.Red, BirdType.Red]);
